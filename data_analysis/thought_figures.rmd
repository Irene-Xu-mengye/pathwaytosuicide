...
p8 <- ggplot(thoughts, aes(x = thoughts_want,  fill = group)) +
  ...
  theme(plot.subtitle = element_text(vjust = -10, hjust = 0.5),
        legend.position = "none",  
        legend.text = element_text(size = 11),
        text = element_text(family = "Times New Roman", face = "bold")) + 
  labs(subtitle = "Amount of Thoughts that \nIncreased one's Desire to Attempt", 
       x = "", y = "")  +
...
p9 <- ggplot(thoughts, aes(x = thoughts_not_want,  fill = group)) +
  ...
  theme(legend.position = "none",  
        legend.text = element_text(size = 11),
        text = element_text(family = "Times New Roman", face = "bold")) + 
  labs(title = "Amount of Thoughts that \nDecreased one's Desire to Attempt", 
       x = "", y = "")  +
  scale_y_continuous(expand = c(0.008, 0), breaks = 0:8) +
...
p11 <- ggplot(thoughts, aes(x = thoughts_net,  fill = group)) +
  ...
  theme(legend.position = "none", 
        legend.text = element_text(size = 11),
        text = element_text(family = "Times New Roman", face = "bold")) + 
  labs(title = "Counterbalanced Amount of Thoughts", 
       subtitle = "(Thoughts Increased Desire minus Thoughts Decreased Desire)",
       x = "", y = "")  +
  scale_y_continuous(expand = c(0.008, 0), breaks = 0:8) +
